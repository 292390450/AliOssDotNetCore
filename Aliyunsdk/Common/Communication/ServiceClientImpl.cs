    ...
    internal static class HttpExtensions
    {
        ...
        internal static void AddInternal(WebHeaderCollection headers, string key, string value)
        {
            ...
            if (_addInternalMethod == null)
            {
              ...
              var  m= typeof(WebHeaderCollection).GetMethod("Add", BindingFlags.NonPublic | BindingFlags.Instance| BindingFlags.Public,null, new Type[] { typeof(string), typeof(string) },null);
